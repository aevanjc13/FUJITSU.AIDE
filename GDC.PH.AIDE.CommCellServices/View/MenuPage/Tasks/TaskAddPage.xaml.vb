...
#End Region
    ...
    Public Sub New(_frame As Frame, _mainWindow As MainWindow, _taskList As TasksModel, _email As String)
        InitializeComponent()
        frame = _frame
        mainWindow = _mainWindow
        email = _email
...
#Region "Button/Events"
    ...
    Private Sub btnBack_Click(sender As Object, e As RoutedEventArgs) Handles btnBack.Click
        frame.Navigate(New TaskAdminPage(frame, mainWindow, txtEmpID.Text, email))
    End Sub
    ...
    Private Sub dpTargetDate_CalendarOpened(sender As Object, e As RoutedEventArgs) Handles dpTargetDate.CalendarOpened
        dpTargetDate.DisplayDateStart = dpStartDate.DisplayDate
    End Sub
