    ...
    Private Sub lv_taskList_MouseDoubleClick(sender As Object, e As MouseButtonEventArgs) Handles lv_taskList.MouseDoubleClick
        ...
        If lv_taskList.SelectedIndex <> -1 Then
            If lv_taskList.SelectedItem IsNot Nothing Then
                ...
                mainFrame.Navigate(New TaskAddPage(mainFrame, mainWindow, taskList, email))
            End If
        End If
    End Sub

    Private Sub btnBack_Click(sender As Object, e As RoutedEventArgs)
        mainFrame.Navigate(New TaskAdminPage(mainFrame, mainWindow, empID, email))
    End Sub
        ...
        Try
            If InitializeService() Then
                ...
                Else
                    ...
                    btnFirst.Visibility = Windows.Visibility.Collapsed
                    btnLast.Visibility = Windows.Visibility.Collapsed
                End If
            End If
