        ...
        If lv_commendation.SelectedIndex <> -1 Then
            ...
            If lv_commendation.SelectedItem IsNot Nothing Then
                For Each _comm As CommendationModel In commendationVM.CommendationList
                    ...
                    End If
                Next
                mainFrame.Navigate(New CommendationAddPage(commmendationList, mainFrame, position, empID))
            End If
        End If
    End Sub

    Private Sub btnCreate_Click(sender As Object, e As RoutedEventArgs) Handles btnCreate.Click
        mainFrame.Navigate(New CommendationAddPage(mainFrame, position, empID))
    End Sub
#End Region
