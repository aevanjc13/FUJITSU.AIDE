...
#Region "Events"
    ...
    Private Sub btnSRAdd_Click(sender As Object, e As RoutedEventArgs) Handles btnSRAdd.Click
        isEmpty = True
        mainFrame.Navigate(New NewSuccessRegister(isEmpty, mainFrame, email))
    End Sub
    ...
    Private Sub lv_successRegisterOwn_MouseDoubleClick(sender As Object, e As SelectionChangedEventArgs) Handles lv_successRegisterOwn.SelectionChanged
        ...
        If lv_successRegisterOwn.SelectedIndex <> -1 Then
            ...
            If lv_successRegisterOwn.SelectedItem IsNot Nothing Then
                ...
                mainFrame.Navigate(New NewSuccessRegister(successRegister, mainFrame, email))
            End If
        End If
...
#Region "Functions"
    ...
    Private Sub DisplayPagingInfo()
        ...
        lblPagingInfo1.Content = pagingInfo
        lblPagingInfo2.Content = pagingInfo
        lblPageNo1.Content = pagingPageIndex
    ...
    Private Sub GUISettingsOff()
        ...
        btnFirst1.IsEnabled = False
        btnLast1.IsEnabled = False
    ...
    Private Sub GUISettingsOn()
        ...
        btnFirst1.IsEnabled = True
        btnLast1.IsEnabled = True
