...
#Region "Constructor"
    ...
    Public Sub New(_mainFrame As Frame, _position As String, _empID As Integer)
    ...
    Public Sub New(_commendation As CommendationModel, mainFrame As Frame,
                   _position As String, _empID As Integer)
...
#Region "Events"
    ...
    Private Sub btnBack_Click(sender As Object, e As RoutedEventArgs) Handles btnBack.Click
        mainFrame.Navigate(New HomePage(mainFrame, position, empID))
    End Sub
    ...
    Private Sub btnCommendationCreate_Click(sender As Object, e As RoutedEventArgs) Handles btnCommendationCreate.Click
        If FindMissingFields() Then
            ...
            If ans = MsgBoxResult.Yes Then
                ...
                comm.EMPLOYEE = txtCommendationEmployees.Text
